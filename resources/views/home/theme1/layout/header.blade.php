    ...
    <div class="container-fluid">
        ...
        <div class="main-nav__main-navigation one-page-scroll-menu">
            <ul class="main-nav__navigation-box">
                ...
                <li class="scrollToLink"><a href="#nasil-calisir">Nasıl Çalışır</a></li>
                <li class="scrollToLink"><a href="#faq">S.S.S</a></li>
                <li class="scrollToLink"><a href="#testimonials">Yorumlar</a></li>
