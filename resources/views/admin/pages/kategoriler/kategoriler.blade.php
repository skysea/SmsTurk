    ...
    <div class="modal fade" data-backdrop="static" id="modalKategoriDuzenle" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body loading-kategori-duzenle">
                    <div class="alert alert-danger" style="display:none"></div>
                   <form id="modal_kategori_duzenle_form" action="" method="post">
                       <input type="hidden" name="hidden_kategori_id">
                       <div class="form-row">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger btn-outline-danger" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Kapat</button>
                    <button  class="btn btn-success btn-kategori-guncelle" ><i class="fa fa-check-circle"></i> Kategori Güncelle</button>
                </div>
            </div>
        </div>
    </div>
